...
function getServiceData(type) {
    const services = {
        business: {
            ...
            prices: [
                { service: '公司设立', price: '800-2000�? },
                { service: '公司变更', price: '500-1500�? },
                { service: '公司注销', price: '1000-3000�? },
                { service: '股权转让', price: '800-2000�? }
            ]
        },
        ip: {
            title: '知识产权服务',
            description: '专业的商标、版权、专利等知识产权注册、变更、转让服�?,
            services: [
                '商标注册申请',
                '商标变更登记',
                '商标转让办理',
            ...
            prices: [
                { service: '商标注册', price: '800-1500�? },
                { service: '商标变更', price: '500-800�? },
                { service: '商标转让', price: '800-1200�? },
                { service: '版权登记', price: '500-1000�? }
            ]
        },
        accounting: {
            title: '会计服务',
            ...
            prices: [
                { service: '小规模纳税人', price: '200-500�?�? },
                { service: '一般纳税人', price: '500-1000�?�? },
                { service: '出口退�?, price: '1000-3000�?�? },
                { service: '税务筹划', price: '面议' }
            ]
        },
        banking: {
            title: '银行开户服�?,
            description: '专业的银行对公账户开设、社保公积金代申请服�?,
            services: [
                '银行对公账户开�?,
                '社保开户代申请',
                '公积金开户代申请',
            ...
            prices: [
                { service: '银行开�?, price: '500-1000�? },
                { service: '社保开�?, price: '300-600�? },
                { service: '公积金开�?, price: '300-600�? },
                { service: '代缴服务', price: '50-100�?�?�? }
            ]
        }
    };
